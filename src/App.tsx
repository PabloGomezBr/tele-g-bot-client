            ...
            <header className='App-header'>
                ...
                <svg style={{ position: 'absolute', top: 0 }} version="1.0" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <g transform="translate(0.000000,108.000000) scale(0.100000,-0.100000)"
                        fill="#FFFFFFFF" fill-opacity="0">
                        <path className="path" stroke="#FFFFFF" stroke-width="10" d="M346 930 c-43 -22 -81 -26 -91 -10 -5 7 -11 8 -19 1 -6 -5 -31 -11
...
40 125 54 -6 18 -30 17 -71 -4z"/>
                        <path className="path" stroke="#FFFFFF" stroke-width="10" d="M541 913 c-74 -26 -111 -86 -111 -179 0 -52 15 -65 77 -67 37 -2 48
...
-1z"/>
                        <path className="path" stroke="#FFFFFF" stroke-width="10" d="M915 861 c-63 -25 -61 -20 -53 -137 8 -116 16 -136 48 -116 11 6 27
...
-26 25 -19 -11 -21 -9 -21 18 0 26 7 34 40 51 64 33 51 59 -15 31z"/>
                        <path className="path" stroke="#FFFFFF" stroke-width="10" d="M1330 813 c-56 -55 -60 -62 -60 -105 0 -31 7 -54 21 -72 18 -23 27
...
55 55 61 0 28 -25 16 -80 -36z"/>
                        <path className="path" stroke="#FFFFFF" stroke-width="10" d="M703 838 c-5 -7 -17 -44 -27 -83 -16 -67 -16 -70 3 -88 16 -16 27
-18 66 -13 59 9 56 32 -4 28 -48 -3 -49 0 -26 93 13 59 8 89 -12 63z"/>
                        <path className="path" stroke="#FFFFFF" stroke-width="10" d="M1807 843 c-10 -18 8 -217 21 -221 9 -3 12 20 12 93 0 66 3 94 11 90
...
79 -13 85 -7 6 -41 15 -76 21 -34 5 -66 12 -70 15 -4 2 -10 1 -12 -3z"/>
                        <path className="path" stroke="#FFFFFF" stroke-width="10" d="M2222 812 c-32 -10 -32 -26 0 -30 l27 -3 3 -96 c2 -66 7 -98 16 -101
9 -3 12 22 12 104 l0 107 65 -5 c65 -6 75 -2 53 20 -13 13 -135 15 -176 4z"/>
                        <path className="path" stroke="#FFFFFF" stroke-width="10" d="M2096 794 c-28 -28 -56 -92 -56 -128 0 -29 5 -38 31 -51 16 -9 45
...
-24 46 1 88 23 38 28 37 53 -10z"/>
                        <path className="path" stroke="#FFFFFF" stroke-width="10" d="M1045 751 c-8 -13 3 -18 63 -26 36 -5 52 -3 52 4 0 24 -101 43 -115
22z"/>
                        <path className="path" stroke="#FFFFFF" stroke-width="10" d="M1617 740 c-65 -7 -60 -24 8 -28 43 -2 55 0 55 12 0 20 -8 22 -63 16z"/>
                        <path className="path" stroke="#FFFFFF" stroke-width="10" d="M912 420 c-22 -9 -23 -13 -20 -116 2 -75 7 -109 16 -112 9 -3 12 21
...
13z"/>
                        <path className="path" stroke="#FFFFFF" stroke-width="10" d="M1333 384 c-7 -18 27 -223 38 -230 5 -2 16 0 26 5 10 6 47 15 82 20
...
-14 15 -13 28 -16 56 -11z"/>
                        <path className="path" stroke="#FFFFFF" stroke-width="10" d="M1155 381 c-34 -14 -56 -47 -62 -90 -7 -53 15 -86 67 -102 36 -11 42
